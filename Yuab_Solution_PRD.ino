//*****************************************************
22.02.10 모터가 저항 값 받지 않으면서 원활히 움직일 수 있는 가변 저항 값이 존재한다
그 값을 찾아야 하는 것이 목표 10% ~20% 설정 해야한다.
가변저항 따라 모터 회전 수 비례하는 것 성공

//**유압 솔루션 PRD 아두이노 코딩**

MDUI RS485 초기화 방법 진행 중
