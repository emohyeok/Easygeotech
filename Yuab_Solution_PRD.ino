...
//---------------------------------------------------------------------------------------------
//                             C W 함 수 선 언 ( B L D C 각 도 시 간 조 절 코 딩 )
//---------------------------------------------------------------------------------------------
...
//---------------------------------------------------------------------------------------------
//                             C C W 함 수 선 언 ( B L D C 각 도 시 간 조 절 코 딩 )
//---------------------------------------------------------------------------------------------
...
//---------------------------------------------------------------------------------------------
//                       C Y C L E 함 수 선 언 ( B L D C 각 도 시 간 조 절 코 딩 )
//---------------------------------------------------------------------------------------------
 //▶▶▶▶▶▶설명◀◀◀◀◀◀◀
...
analogWrite(RPM,50); // RPM "400"RPM (400RPM - 2000RPM 기준 0.5 x 255 - 50 analogWrite) 설정 변경 가능
delay(1000); // * 수정해야함 임의로 시간을 잠아놓은 것* (각도 예시로 잡아놓은 3도의 움직임)
...
Serial.println(count); // 위치 파악 용 시리얼 변수 

}

//---------------------------------------------------------------------------------------------
//                           W O R K 함 수 선 언 ( B L D C 각 도 시 간 조 절 코 딩 )
//---------------------------------------------------------------------------------------------
 //▶▶▶▶▶▶설명◀◀◀◀◀◀◀
...
//---------------------------------------------------------------------------------------------
//                          T U R N  함 수 선 언 ( B L D C 각 도 시 간 조 절 코 딩 )
//---------------------------------------------------------------------------------------------
 //▶▶▶▶▶▶설명◀◀◀◀◀◀◀
